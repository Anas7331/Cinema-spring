...
import javax.transaction.Transactional; import org.sid.cinema.dao.CategoryRepository;
...
public class CinemaInitServiceImpl implements ICinemaInitService {
  ...
  public void initCinemas() {
    ...
    Stream.of("MegaRama","IMAX"/*,"FOUNOUN","CHAHRAZAD","DAOULIZ"*/)
     ...
     cinema.setNombreSalles(1+(int)(Math.random()*7));
     cinema.setVille(v);
  ...
  salle.setNombrePlace(1+(int)(Math.random()*9));
